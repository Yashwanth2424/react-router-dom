  ...
  return (
      ...
      <div class="grid md:grid-cols-3 items-center shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-xl overflow-hidden">
        ...
        <form class="md:col-span-2 w-full py-6 px-6 sm:px-16 max-md:max-w-xl mx-auto">
          ...
          <p class="text-gray-600 text-sm mt-6 text-center">Already have an account? <NavLink to={"/login"} href="javascript:void(0);"><span  class="text-blue-600 font-semibold hover:underline ml-1">Login here</span></NavLink></p>
        </form>
      </div>
    </div>
  )
