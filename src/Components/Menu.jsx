...
function Menu() {
  return (
      ...
      <h2 class="text-2xl sm:text-3xl font-bold text-gray-800 text-center mb-6 sm:mb-10">Coffee & Tea</h2>
      <div class="grid grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 mb-16">
