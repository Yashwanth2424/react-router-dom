  ...
  return (
      ...
      <div class='flex flex-wrap items-center justify-between gap-5 w-full'>
          ...
          <ul
            ...
            <li class='max-lg:border-b border-gray-300 max-lg:py-3 px-3'>
              <NavLink to={"/"} href='javascript:void(0)'
                ><span class='hover:text-[#007bff]  block font-semibold text-[15px]'>Home</span></NavLink>
            </li>
            <li class='max-lg:border-b border-gray-300 max-lg:py-3 px-3'><NavLink to={"/team"} href='javascript:void(0)'
              ><span class='hover:text-[#007bff]  block font-semibold text-[15px]'>Team</span></NavLink>
            </li>
            <li class='max-lg:border-b border-gray-300 max-lg:py-3 px-3'><NavLink to={"/feature"} href='javascript:void(0)'
              ><span class='hover:text-[#007bff]  block font-semibold text-[15px]'>Feature</span></NavLink>
            </li>
            <li class='max-lg:border-b border-gray-300 max-lg:py-3 px-3'><NavLink to={"blog"} href='javascript:void(0)'
              ><span class='hover:text-[#007bff]  block font-semibold text-[15px]'>Blog</span></NavLink>
            </li>
            ...
            ><span class='hover:text-[#007bff]  block font-semibold text-[15px]'>Contact</span></NavLink>
            </li>
          </ul>
        </div>
        ...
        <div class='flex max-lg:ml-auto space-x-4'>
          <NavLink to={"/login"}>
          <button class='px-4 py-2 text-sm rounded-full font-bold text-gray-500 border-2 bg-transparent hover:bg-gray-50 transition-all ease-in-out duration-300'>Login</button>
          </NavLink>
          <NavLink to={"/register"}>
          <button
